...
export class App {
  ...
  constructor(containerId: string) {
    ...
    const PANEL_SPANS_KEY = 'rudraas-panel-spans';
    ...
    const storedVariant = localStorage.getItem('rudraas-variant');
    ...
    if (storedVariant !== currentVariant) {
      ...
      localStorage.setItem('rudraas-variant', currentVariant);
      ...
      const PANEL_ORDER_MIGRATION_KEY = 'rudraas-panel-order-v1.9';
      ...
      if (currentVariant === 'tech') {
        const TECH_INSIGHTS_MIGRATION_KEY = 'rudraas-tech-insights-top-v1';
    ...
    const LAYOUT_RESET_MIGRATION_KEY = 'rudraas-layout-reset-v2.5';
  ...
  public async init(): Promise<void> {
    ...
    this.eventHandlers.setupSignalsWindow();
