        ...
        <div class="header-left">
          <div class="variant-switcher">${(() => {
            ...
            <a href="${vHref('full', '/')}"
               ...
               data-variant="full"
               ${vTarget('full')}
               title="GEOPOLITICAL${SITE_VARIANT === 'full' ? ` ${t('common.currentVariant')}` : ''}">
              <span class="variant-icon">🌐</span>
              <span class="variant-label">GEOPOLITICAL</span>
            </a>
            ...
            <a href="${vHref('tech', '/')}"
               ...
               data-variant="tech"
               ${vTarget('tech')}
               title="DEFENSE${SITE_VARIANT === 'tech' ? ` ${t('common.currentVariant')}` : ''}">
              <span class="variant-icon">🛡️</span>
              <span class="variant-label">DEFENSE</span>
            </a>
            <span class="variant-divider"></span>
            <a href="${vHref('finance', '/')}"
               ...
               ${vTarget('finance')}
               title="ECONOMIC${SITE_VARIANT === 'finance' ? ` ${t('common.currentVariant')}` : ''}">
              <span class="variant-icon">📊</span>
              <span class="variant-label">ECONOMIC</span>
            </a>
            ...
            <a href="${vHref('happy', '/')}"
               ...
               data-variant="happy"
               ${vTarget('happy')}
               title="SITUATIONAL ${t('common.currentVariant')}">
              <span class="variant-icon">📡</span>
              <span class="variant-label">SITUATIONAL</span>
            </a>` : ''}`;
          })()}</div>
          <div class="logo-img-group">
            <img src="/Rudraas_Dynamics_LOGO.png" class="logo-wordmark" alt="RUDRAAS Intelligence Command" draggable="false" onerror="console.error('[RUDRAAS] Logo not found:',this.src);this.style.display='none'" />
          </div><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">RESTRICTED</span>' : '<span class="beta-badge always-show">RESTRICTED</span>'}
