...
export const shareTexts = {
  twitter: (data: StoryData) =>
    ...
    `\nGenerated by RUDRAAS Intelligence Command`,
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via RUDRAAS Intelligence Command — RUDRAAS Dynamics`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - RUDRAAS Intelligence Command`)}`,
