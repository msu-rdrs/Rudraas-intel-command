...
const VARIANT_META: Record<string, {
  ...
  full: {
    title: 'RUDRAAS Intelligence Command - Geopolitical Dashboard',
    description: 'Real-time geopolitical intelligence dashboard with live news, military tracking, conflict zones, infrastructure monitoring, and situation awareness. Built for RUDRAAS Dynamics.',
    keywords: 'RUDRAAS, geopolitical intelligence, military bases, nuclear facilities, undersea cables, conflict zones, real-time monitoring, situation awareness, OSINT, flight tracking, AIS ships, earthquake monitor, protest tracker, power outages, India defense',
    url: '/',
    siteName: 'RUDRAAS Intelligence Command',
    shortName: 'RIC',
    subject: 'Real-Time Geopolitical Intelligence and Situation Awareness',
    classification: 'Defense Intelligence Platform, OSINT Tool',
    ...
    features: [
      ...
      'UAV/UAS situational awareness',
    ],
  },
  tech: {
    title: 'RUDRAAS Intelligence Command - Defense Dashboard',
    description: 'Real-time defense and military intelligence dashboard tracking UAV/UAS activity, military assets, defense technology, and strategic capabilities.',
    keywords: 'RUDRAAS defense, UAV intelligence, UAS tracking, military technology, defense systems, drone tracking, India defense, strategic assets, defense tech',
    url: '/',
    siteName: 'RUDRAAS Intelligence Command',
    shortName: 'RIC-DEF',
    subject: 'Defense Technology and Military Intelligence',
    classification: 'Defense Dashboard, Military Intelligence Tracker',
    categories: ['defense', 'intelligence'],
    features: [
      'UAV/UAS tracking',
      'Military asset monitoring',
      'Defense technology intelligence',
      'Strategic capabilities mapping',
      'Drone activity tracking',
      'Defense news aggregation',
    ],
  },
  happy: {
    title: 'RUDRAAS Intelligence Command - Situational Awareness',
    description: 'Real-time situational awareness dashboard for strategic monitoring and defense intelligence.',
    keywords: 'RUDRAAS situational awareness, strategic monitoring, defense intelligence, India defense, real-time situation',
    url: '/',
    siteName: 'RUDRAAS Intelligence Command',
    shortName: 'RIC-SIT',
    subject: 'Situational Awareness and Strategic Monitoring',
    classification: 'Situational Awareness Platform',
    categories: ['intelligence', 'defense'],
    features: [
  ...
  finance: {
    title: 'RUDRAAS Intelligence Command - Economic Dashboard',
    description: 'Real-time economic and financial intelligence dashboard tracking global markets, commodities, defense spending, and economic indicators.',
    keywords: 'RUDRAAS economic, defense economics, commodities, oil prices, defense spending, global markets, economic intelligence, India economy',
    url: '/',
    siteName: 'RUDRAAS Intelligence Command',
    shortName: 'RIC-ECO',
    subject: 'Economic Intelligence and Financial Monitoring',
    classification: 'Economic Intelligence Platform, Market Tracker',
    categories: ['finance', 'intelligence'],
    features: [
  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "RUDRAAS Intelligence Command"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "RIC"/, `"alternateName": "${activeMeta.shortName}"`)
        .replace(/"url": "\/"/, `"url": "${activeMeta.url}"`)
        .replace(/"description": "AI-powered real-time defense intelligence platform with live news, markets, military tracking, infrastructure monitoring, and geopolitical data. Built for RUDRAAS Dynamics."/, `"description": "${activeMeta.description}"`)
